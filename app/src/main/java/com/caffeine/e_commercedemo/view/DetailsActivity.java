...
public class DetailsActivity extends AppCompatActivity {
    ...
    private void getProductDetails(String id){
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ProductDetails product = snapshot.getValue(ProductDetails.class);
    ...
    private void showDetailsToActivity(ProductDetails product) {
        ...
        DetailedImageAdapter adapter = new DetailedImageAdapter(this, binding.headerImage, product.getImages());
